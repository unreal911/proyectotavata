      ...
      t &&
        t.addEventListener("click", (a) => {
          a.target.hasAttribute("data-kanban-collapse") &&
            a.target.closest(".kanban-column").classList.toggle("collapsed");
        }),
        a.forEach((a) =>
            ...
            if (n.data("theme-control")) {
              ...
              switch (
                ("phoenixTheme" === i &&
                  "boolean" == typeof l &&
                  (l = l ? "dark" : "light"),
                config.hasOwnProperty(i) && window.config.set({ [i]: l }),
                ...
                case "phoenixTheme": {
                  ...
                  e.currentTarget.dispatchEvent(t), changeTheme(o.node);
                  break;
                }
                case "phoenixNavbarVerticalStyle":
                  a.classList.remove("navbar-darker"),
                    "default" !== l && a.classList.add(`navbar-${l}`);
                  break;
                case "phoenixNavbarTopStyle":
                  r.classList.remove("navbar-darker"),
                    "transparent" !== l && r.classList.add(`navbar-${l}`);
                  break;
                ...
                case "phoenixNavbarPosition":
                  ...
                  break;
                case "phoenixIsRTL":
                  window.config.set({ phoenixIsRTL: n.node.checked }),
    ...
    const { merge: merge } = window._,
      tinymceInit = () => {
        ...
        if (window.tinymce) {
          ...
          o &&
            o.addEventListener("clickControl", ({ detail: { control: t } }) => {
              "phoenixTheme" === t &&
                i.forEach((t) => {
                  window.tinymce
                    .get(t.id)
      ...
      document.querySelectorAll(t.WIZARDS).forEach((l) => {
        ...
        i.forEach((e) => {
          ...
          h.addEventListener(d, () => {
            (m -= 1), b[m].show(), L && (L.innerHTML = `${m + 1}/${b.length}`);
          }),
          o.length &&
            o.forEach((t, a) => {
              t.addEventListener(s, (a) => {
                ...
                t.addEventListener(r, () => {
                  ...
                  m > o.length - 2 && S && (w.textContent = "Submit"),
                    m > o.length - 2 && !S
